                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-2 col-xs-1">
                                ...
                                <a style="font-weight:bold" href="about.php"><span dir="rtl">En</span></a>
                                  <a style="font-family: 'Droid Arabic Kufi', serif;" href="./ar/about.php"><span dir="rtl">عربي</span></a>
                            </div><!-- .col-md-2 end -->
                        </div><!-- .row end -->
                    </div><!-- .container end -->
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-md-12 centered mb-0">
                        ...
                        <div class="text triggerAnimation animated" data-animate='fadeInDown'>
                            <p>1-	Provide engineering solutions to meet the needs of all customers.</p>
							<p>2-	Design, supervision and implementation of projects of all kinds</p>
							<p>3-	Representing international companies in Syria.</p>
							<p>The company has qualification engineers, foremen and technicians specialized in heating and conditioning systems, alternative energy.
