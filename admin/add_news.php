...
<!--grid-->
 	...
 	<!---->
        ...
        <form method="post" action="news_controller.php?status=add" enctype="multipart/form-data">
            ...
            <div class="col-md-12 form-group1 ">
              ...
              <textarea  placeholder="Description..." name="en_desc" required=""></textarea>
            </div>
            ...
            <div class="col-md-12 form-group1 ">
              ...
              <textarea  placeholder="Description..." name="ar_desc" required=""></textarea>
            </div>
