									...
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Products</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul id="menu-academico-sub" >
												...
												<li id="menu-academico-avaliacoes" ><a href="product_edit.php">Edit</a></li>
											</ul>
										</li>
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Projects</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul id="menu-academico-sub" >
												<li id="menu-academico-avaliacoes" ><a href="add_project.php">Add</a></li>
												<li id="menu-academico-avaliacoes" ><a href="project_edit.php">Edit</a></li>
											</ul>
										</li>
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> News</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul id="menu-academico-sub" >
												<li id="menu-academico-avaliacoes" ><a href="add_news.php">Add</a></li>
												<li id="menu-academico-avaliacoes" ><a href="news_edit.php">Edit</a></li>
											</ul>
										</li>
									</ul>
							</div>
