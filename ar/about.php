...
<head>
    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <nav class="navbar navbar-default nav-left" role="navigation">
                                        ...
                                        <!-- MAIN NAVIGATION -->
                                  <div dir="rtl" class="collapse navbar-collapse" id="navbar-collapse">
        ...
        <!-- .page-content start -->
        <div dir="rtl" style="background-image: url('../img/page-titles/page-title-1.jpg')" class="page-content custom-img-background dark page-title page-title-1 mb-70">
            <div class="container">
                <!-- .row start -->
                <div class="row">
                    <div class="col-md-6">
...
.
         ...
         <!-- .page-content start -->
         <div  dir="rtl" style="background-image: url('../img/pics/bkg-img1.jpg')" class="page-content quote style-2 custom-img-background dark bkg-img1 mb-70">
            <!-- .container start -->
            <div  class="container">
                <!-- .row start -->
                <div class="row mb-0">
                    ...
                    <div class="col-md-12 centered mb-0">
                        ...
                        <div class="text triggerAnimation animated" data-animate='fadeInDown'>
                            <p>1-	تقديم الحلول الهندسية بما يرضي احتياجات جميع الزبائن .</p>
							<p>2-	التصميم والا شراف و التنفيذ للمشاريع بمختلف أنواعها </p>
							<p>3-	تمثيل الشركات العالمية في سوريا .</p>
							<p>تضم الشركة نخبة من المهندسين والفنيين المختصين في مجال أنظمة التدفئة والتكييف والطاقات البديلة.
							
							</p>
                        </div>
                        <p class="author-name triggerAnimation animated" data-animate='fadeInDown'><b>امين قطنة , المؤسس.</b></p>
                    </div><!-- .col-md-12 end -->
                </div><!-- .row end -->
            </div><!-- .container end -->
        ...
        <!-- .page-content start -->
        <div dir="rtl" class="page-content quote style-1 custom-background bkg-black dark">
            <!-- .container start -->
            <div class="container">
                <!-- .row start -->
                <div class="row mb-0">
