...
<head>
    ...
    <body>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-2 col-xs-1">
                                ...
                                <a style="font-weight: bold" href="../contact.php"><span dir="ltr">En</span></a>
                                <a style="font-family: 'Droid Arabic Kufi', serif;" href="contact.php"><span dir="ltr">عربي</span></a>
                            </div><!-- .col-md-2 end -->
                        </div><!-- .row end -->
                    </div><!-- .container end -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p>لديك سؤال بالنسبة لنا؟ يرجى ملء النموذج أدناه وسنقوم بالرد خلال 24 ساعة.</p>
                        <!-- .contact-form start -->
                        <div class="contact-form">                                
                            <form method="post" action="mail.php" class="wpcf7">
                                <div class="form-group">
                                    <label>
                                        <span class="required">*</span> الاسم الكامل:
                                    </label>
                                    <input name="author" type="text" class="wpcf7-text form-control" id="contact-name" >
                                </div>
                                ...
                                <div class="form-group wpcf7-message">
                                    <label>
                                        الرسالة (<span class="italic">Optional</span>):
                                    </label>
                                    <textarea name="message"  class="wpcf7-textarea form-control" id="contact-message" rows="4"></textarea>
                                </div>

                                <div dir="ltr" class="g-recaptcha" data-sitekey="6LeyFkUUAAAAAFbcRCHtPiKIf30XFRgnSSYWbK_m"></div>

                                <input type="submit" class="wpcf7-submit btn btn-primary float-right comment-reply" value="ارسال" />
                            ...
                            <li class="widget widget-text">
                                ...
                                <ul>
                                    <li class="strong-item">
                                        ...
                                        العنوان: روضة الميدان دمشق سوريا 
                                    </li>
                                    <li class="strong-item">
                                        <span class="icon-container">
                                            <img src="../img/svg/clock.svg" class="img-responsive" alt="clock icon"/>
                                        </span>
                                        السبت -الخميس: 09:00 - 17:00
                                    </li>
                                    <li class="strong-item">
                                        <span class="icon-container">
                                            <img src="../img/svg/email.svg" class="img-responsive" alt="email icon"/>
                                        </span>
                                        البريد الالكتروني: info@rafah-ltd.com
                                    </li>
                                </ul>
       ...
       <div dir="ltr" id="copyright-container">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCeRo96D56GFNf4lsYWiWbzQCh38eauUCo&callback=initMap"
        ...
        <script>
            ...
            jQuery(document).ready(function ($) {
                ...
                function initialize() {
                    ...
                    var damascus = new google.maps.LatLng(33.492645, 36.304929);
