                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-1">
                                ...
                                <a style="font-weight: bold" href="../projects.php"><span dir="ltr">En</span></a>
                                <a style="font-family: 'Droid Arabic Kufi', serif;" href="projects.php"><span dir="ltr">عربي</span></a>
                            </div><!-- .col-md-2 end -->
                        </div><!-- .row end -->
                    </div><!-- .container end -->
                                ...
                                <div class="gallery-img">
                                    ...
                                    <div class="hover-mask-container">
                                        <div class="hover-zoom">
                                            <a href="project-single.php?id='.$project['id'].'">'.$project['ar_title'].'
                                                <span class="icon-container">
