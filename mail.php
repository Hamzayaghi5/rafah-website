...
$response = file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LcEp5kUAAAAAMOG5Slgom8-yanHNK-fYotfnouB&response=" . $captcha . "&remoteip=" . $_SERVER['REMOTE_ADDR']);
