...
<html>
        ...
        include ('config.php');
        $id=$_GET['id'];
        $cmd="select en_title,DATE_FORMAT(date,'%b %d %Y') as date1,en_desc,url FROM news where id=$id";
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-1">
                                ...
                                <a style="font-weight: bold" href="news-single.php?id=<?php echo $id;?>"><span dir="rtl">En</span></a>
                                <a style="font-family: 'Droid Arabic Kufi', serif;" href="./ar/news-single.php?id=<?php echo $id; ?>"><span dir="rtl">عربي</span></a>
                            </div><!-- .col-md-2 end -->
                        </div><!-- .row end -->
                    </div><!-- .container end -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#"><strong style="color: #fff">Home</strong></a></li>
                            <li><a href="#"><strong style="color: #fff">News</strong></a></li>
                        ...
                        <div class="blog-post clearfix">
                            ...
                            <div class="post-body">
                                ...
                                <div class="custom-heading">
                                        ...
                                        <h4><?php echo $single_news['en_title'] ?></h4>
                                 
                                </div>

                                <p> <?php echo  $single_news['en_desc'] ?>  </p>
                                <div class="widget pixely_widget_sharrre clearfix">
                                    <ul class="clearfix">
                                        <li>
                                            <div  class="sharrre-facebook" data-url="Rafah.ltd/news-single.php?id=<?php echo $id ?>" data-text=<?php echo  $single_news['en_desc'] ?>> 
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div  class="sharrre-linkedin" data-url="Rafah.ltd/news-single.php?id=<?php echo $id ?>"data-text=<?php echo  $single_news['en_desc'] ?>></div>
                                        </li>

                                        <li>
                                            <div  class="sharrre-google-plus" data-url="Rafah.ltd/news-single.php?id=<?php echo $id ?>"data-text=<?php echo  $single_news['en_desc'] ?>></div>
                                        </li>
                                    </ul>
