...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2019 at 08:54 PM
...
CREATE TABLE `category` (
  ...
  `type` enum('hisense','multitubo') COLLATE utf8_bin NOT NULL,
...
INSERT INTO `category` (`id`, `name`, `type`, `parent`) VALUES
(1, 'outdoor unit series', 'hisense', 7),
(2, 'indoor unit series', 'hisense', 7),
(3, 'air to water unit', 'hisense', 0),
(4, 'chiller', 'hisense', 0),
(5, 'fresh air systems', 'hisense', 7),
(6, 'controller', 'hisense', 0),
(7, 'vrf', 'hisense', 0);
...
--
ALTER TABLE `service`
  ADD CONSTRAINT `service_ibfk_1` FOREIGN KEY (`type`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
